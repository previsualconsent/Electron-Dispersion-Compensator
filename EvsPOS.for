      ...
      parameter (mxparm=120,neq=6,p=1,q=3,r=21)
      ...
      real*8 tftold,hiTstep,lowTstep,wfTstep,bTstep,scandata(p,q,0:scanl*2),scandx(1:r,0:scanl*2)
...
61    format(x,'counter=',i1,8x,'steps=',i10)
          ...
          do l=1,q
              do k=1,p
                  ...
                  y(4)=(1.00D0+2D0**1*dE/4*(l-midl))*vini*cos(dtheta/2*(k-midk))
                  y(5)=(1.00D0+2D0**1*dE/4*(l-midl))*vini*sin(dtheta/2*(k-midk))
